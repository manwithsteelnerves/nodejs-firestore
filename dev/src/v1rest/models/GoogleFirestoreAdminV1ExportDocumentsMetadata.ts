 ...
 */
export class GoogleFirestoreAdminV1ExportDocumentsMetadata {
  /**
   ...
   */
  operationState?: GoogleFirestoreAdminV1ExportDocumentsMetadata.OperationStateEnum;
  /**
...
export namespace GoogleFirestoreAdminV1ExportDocumentsMetadata {
